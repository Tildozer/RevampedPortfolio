  ...
  return (
    ...
    >
      <Link
        ...
        target="_blank"
        ref={githubContainer}
        className="text-3xl text-orange-400 dark:text-cyan-400 bg-black dark:bg-slate-600 p-2 rounded-md hover:shadow-md hover:shadow-black dark:hover:shadow-slate-300 hover:-translate-y-1 transition duration-500"
      >
        <PiGithubLogoDuotone />
      </Link>
      <Link
        ...
        className="text-3xl bg-black dark:bg-slate-600 text-[#0077b5] dark:text-white p-2 rounded-md hover:shadow-md hover:shadow-black dark:hover:shadow-slate-300 hover:-translate-y-1 transition duration-500"
      >
        <PiLinkedinLogoFill />
      </Link>
    </div>
